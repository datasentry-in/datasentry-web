...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-10 md:py-16 border-t-8 border-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 font-mono text-sm text-gray-400">
                ...
                <li><Link href="/contact" target="_blank" className="hover:text-primary transition-colors">Contact</Link></li>
              </ul>
            </div>
